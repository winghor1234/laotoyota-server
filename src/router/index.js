...
router.get("/user/profile", auth, UserController.GetProfile); //add new
...
router.put("/user/updatePoint", auth, UserController.UpdatePoint); // add new
router.delete("/user/delete/:customer_id", auth, authSuperAdmin, UserController.DeleteCustomer); //add new
