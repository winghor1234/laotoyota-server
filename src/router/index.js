...
router.get("/service/export", auth, authAdminOrSuperAdmin, ServiceController.ExportService);
...
router.get("/fix/getAllByBranch", auth, authAdminOrSuperAdmin, FixController.getAllFixByBranch);
router.get("/fix/export", auth, authAdminOrSuperAdmin, FixController.ExportFix);
